...
int main(int argc, char** argv){
    ...
    string fileOutputGtau("data/"+frontEnd+"Gtau_2D_mapping_U_"+to_string(u_init)+"_"+to_string(u_step)+"_"+to_string(u_max)+"_beta_"+to_string(beta_init)+"_"+to_string(beta_step)+"_"+to_string(beta_max)+"_Nomega"+to_string(Nomega)+"_Nk"+to_string(Nk)+".dat");
    string fileOutputChi("data/"+frontEnd+"Chisp_2D_mapping_U_"+to_string(u_init)+"_"+to_string(u_step)+"_"+to_string(u_max)+"_beta_"+to_string(beta_init)+"_"+to_string(beta_step)+"_"+to_string(beta_max)+"_Nomega"+to_string(Nomega)+"_Nk"+to_string(Nk)+".dat");
    #endif
    ...
    for (double beta=beta_init; beta<=beta_max; beta+=beta_step){
        ...
        for (double u=u_init; u<=u_max; u+=u_step) {
            ...
            std::tuple< std::complex<double>, std::complex<double> > chis;
            ...
            outputFileMeanChi << std::get<0>(chis).imag() << " ";
            outputFileMeanChi0 << std::get<1>(chis).imag() << " ";
